...
Route::get('check-service-base-price-details/{product_id}/{service_id}/{package_type}',[adminPackageController::class,'check_service_base_price_details']);

Route::get('check-service-base-price-details-update/{product_id}/{service_id}/{package_type}/{package_id}',[adminPackageController::class,'check_service_base_price_details_update']);
