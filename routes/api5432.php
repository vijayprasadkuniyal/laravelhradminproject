...
Route::get('category-based-stock/{id}',[StockController::class,'category_based_stock']);
...
Route::get('get-client-details/{emp_id}',[clientDetailsController::class,'get_client_details']);
Route::get('get-today-followup-client-details/{emp_id}',[clientDetailsController::class,'get_today_followup_client_details']);
...
Route::get('get-verified-client-details/{emp_id}',[clientDetailsController::class,'get_verified_client_details']);
Route::get('create-client-package',[clientDetailsController::class,'create_client_package']);
Route::get('check-service-base-price-details/{product_id}/{service_id}/{category_id}/{package_type}',[adminPackageController::class,'check_service_base_price_details']);

Route::get('check-service-base-price-details-update/{product_id}/{service_id}/{category_id}/{package_type}/{package_id}',[adminPackageController::class,'check_service_base_price_details_update']);

Route::get('check-client-pancard-number/{pancard_no}',[clientDetailsController::class,'check_client_pancard_number']);
...
Route::get('check-unlimited-service-base-price-details/{product_id}/{service_id}/{package_type}',[adminPackageController::class,'check_unlimited_service_base_price_details']);

Route::get('check-unlimited-service-base-price-details-update/{product_id}/{service_id}/{package_type}/{package_id}',[adminPackageController::class,'check_unlimited_service_base_price_details_update']);
...
Route::get('genrate-new-invoice/{package_id}/{client_id}',[ClientInvoiceController::class,'genrate_new_invoice']);
...
Route::get('count-sales-followup-data',[SalesFunnelController::class,'count_sales_followup']);
...
Route::get('genrate-new-invoice',[ClientInvoiceController::class,'genrate_new_invoice']);
