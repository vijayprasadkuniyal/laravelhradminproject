...
Route::get('get-document-type',[clientDetailsController::class,'get_document_type']);
...
Route::get('get-package-category-list',[adminProductController::class,'get_package_category_list']);
...
Route::get('get-wallet-details/{client_id}',[clientDetailsController::class,'get_wallet_details']);
...
Route::get('sales-document-type-list',[clientDetailsController::class,'sales_document_type_list']);
Route::get('sales-package-type',[clientDetailsController::class,'sales_package_type']);
Route::get('product-category',[clientDetailsController::class,'product_category']);
Route::post('save-sales-document',[clientDetailsController::class,'save_sales_document']);
Route::get('sales-document-status/{id}',[clientDetailsController::class,'sales_doc_status']);
Route::post('sales-document-status-change',[clientDetailsController::class,'sales_document_status_change']);
Route::get('sales-document-edit/{id}',[clientDetailsController::class,'sales_document_edit']);
Route::post('sales-document-update/{id}',[clientDetailsController::class,'sales_document_update']);
////utm
