...
Route::get('view-package-lead-details/{pkgId}',[csDetailsController::class,'view_package_lead_details']);
...
Route::get('lead-sale-price/{emp_id}',[SalesFunnelController::class,'lead_sale_price']);
...
Route::get('get-client-followup-status/{followupStatus}',[clientDetailsController::class,'get_client_followup_status']);
    ...
    Route::get('get-google-access-token',[CommunicationApis::class,'getGoogleAccessToken']);
    Route::get('get-google-access-token-zoopgo',[CommunicationApis::class,'getGoogleAccessToken']);
...
//Route::get('invoice-download/{year}/{month}/clientid/fileName', [ClientInvoiceController::class, 'invoice_download'])->name('file.download');
