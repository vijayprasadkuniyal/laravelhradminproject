...
Route::get('logout-details',[LoginController::class,'logout_details']);
...
Route::get('get-employee-group-list/{emp_id}',[CompanyTargetController::class,'get_employee_group_list']);
Route::post('get-sales-managers-list',[CompanyTargetController::class,'get_sales_manager']);
Route::get('get-lead-details',[CompanyTargetController::class,'get_lead_details']);
//wfh
...
Route::post('wfh-attendance-update',[WorkFromHomeController::class,'wfh_attendance_update']);
...
Route::post('auto-update-break-time',[EmpBasicinfoController::class,'auto_update_break_time']);
Route::get('break-time-report',[LoginController::class,'break_time_report']);
Route::get('get-break-time-details',[LoginController::class,'get_break_time_details']);
Route::get('break-attributes-name',[LoginController::class,'break_attributes_name']);
Route::get('idle-time-report',[LoginController::class,'idle_time_report']);
Route::get('idle-time-details',[LoginController::class,'get_idle_time_details']);
});
Route::get('get-package-city-details/{group_id}',[adminPackageController::class,'get_package_city_details']);
Route::get('other-group-payment',[CompanyTargetController::class,'other_group_payment_done']);
Route::get('product-wise-target',[CompanyTargetController::class,'product_wise_target']);
Route::get('get-amount-details',[CompanyTargetController::class,'get_amount_details']);
Route::get('get-kra-kpi',[CompanyTargetController::class,'get_kra_kpi']);
Route::post('manager-target-details',[CompanyTargetController::class,'manager_target_details']);
Route::post('show-team-wise-target-sales',[CompanyTargetController::class,'show_team_wise_target_sales']);
...
Route::get('active-company-goal',[CompanyTargetController::class,'active_company_goal']);
Route::post('carry-forward-target',[CompanyTargetController::class,'carry_forward_target']);
Route::get('show-packages-target-details',[CompanyTargetController::class,'show_packages_target_details']);
Route::get('show-packages-target',[CompanyTargetController::class,'show_packages_target']);
