...
Route::post('assign-pip-task',[EmpHistoryController::class,'pip_task_saved']);
Route::get('pip-list',[EmpHistoryController::class,'pip_list']);
Route::get('view-pip-description/{id}',[EmpHistoryController::class,'view_pip_description']);
Route::post('pip-task-status-update',[EmpHistoryController::class,'pip_task_status_update']);
Route::get('emp-pip-task/{id}',[EmpHistoryController::class,'emp_pip_task']);
...
Route::get('get-city-based-on-locality/{id}',[clientDetailsController::class,'get_city_based_on_locality']);
...
Route::get('remove-compititor/{comp_id}/{packageId}',[clientDetailsController::class,'remove_compititor']);
...
Route::post('update-guest-client-details',[SalesFunnelController::class,'update_business_lead_followup_data']);
