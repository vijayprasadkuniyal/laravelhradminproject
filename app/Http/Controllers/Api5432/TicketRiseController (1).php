...
public function get_assign_ticket_list($id){
   ...
   public function get_ticket_details($id){
    ...
    return response()->json(['status'=>200,'message'=>'Ticket Details','data'=>$data,'assign'=>$assignedMemberNames,'assign_array'=>$assignids,'assign_from'=>$assign_from,'raise_by'=>$ticket_raise_by->created_by,'product'=>$product->product_name,'ticket_raise_by'=>$emp_name->emp_fname,'new_time'=>$time]);
