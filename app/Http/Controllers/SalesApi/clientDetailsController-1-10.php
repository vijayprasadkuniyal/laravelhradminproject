...
class clientDetailsController extends Controller
{
    ...
    public function get_package_leads_details($pkgId)
    {
        ...
        ->select('leads_info.id','leads_info.enq_id','leads_info.client_id','leads_info.package_id','sent_status','leads_info.sent_date','leads_info.status','enquiry_info.city_from','enquiry_info.city_to','enquiry_info.distance','enquiry_info.customer_id','customer_info.name','customer_info.primary_no','customer_info.email')
