...
public function emp_confirmation_details(Request $request){
  ...
  $data = BasicInfo::leftjoin('department','department.id','emp_basic_info.dept_id')
              ...
              ->select('department.department_name','designation.designation_name','branch_details.branch_name','emp_basic_info.emp_id','emp_basic_info.emp_fname','emp_basic_info.emp_lame','emp_basic_info.is_confirmed','emp_basic_info.emp_doc','emp_basic_info.emp_doj',
                DB::raw('CASE 
